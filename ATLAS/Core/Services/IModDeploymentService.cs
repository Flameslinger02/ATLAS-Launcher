...
public interface IModDeploymentService
{
    ...
    /// <summary>Removes deployed <c>@*</c> links in the server directory that are no longer enabled.</summary>
    Task CleanupStaleDeployedModsAsync(ServerProfile profile, CancellationToken ct = default);
